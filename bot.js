...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['!.invite','!.help','my prefix is "!."','By Abo Khalil','14 Server'];
    var i = -1;
    var j = 0;
...
** _ اوامر الميوزك _
╔[❖══════════════════════❖]╗
|  لإدخال البوت الروم الصوتي  |
| **__ ملاحظة : **__يجب عليك ادخال البوت قبل التشغيل  |
| ----    !.join    ----|
╚[❖══════════════════════❖]╝
╔[❖══════════════════════❖]╗
|  لتشغيل الصوتيات او الميوزك  |
| ----    !.play    ----|
╚[❖══════════════════════❖]╝
╔[❖══════════════════════❖]╗
|  لإيقاف الصوتيات او الميوزك  |
| ----    !.stop    ----|
╚[❖══════════════════════❖]╝
╔[❖══════════════════════❖]╗
|   لنغيير مستوى الصوت المشغل في الوقت الحالي  |
| ----    !.vol   ----|
╚[❖══════════════════════❖]╝
** _ اوامر الميوزك _
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
